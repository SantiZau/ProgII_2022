...
namespace ABMC_Carrera
{
    public partial class FrmPrincipal : Form
    {
        ...
        private void asignaturasTotalesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FrmAsignaturSimple asignaturSimple = new FrmAsignaturSimple();
            asignaturSimple.ShowDialog();
        }
    }
}
